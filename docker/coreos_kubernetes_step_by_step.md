...
[Original URL](https://coreos.com/kubernetes/docs/latest/getting-started.html)

> This guide will walk you through a deployment of a single-master/multi-worker Kubernetes cluster on CoreOS. We're going to: configure an etcd cluster for Kubernetes to use generate the...
...
You can simply start etcd via [cloud-config](https://coreos.com/os/docs/latest/cloud-config.html#etcd2) when you create your CoreOS machine or start it manually.
...
This means it is necessary to have a Certificate Authority and generate the proper credentials. Generate the necessary assets from existing PKI infrastructure, or by following [these OpenSSL-based instructions](https://coreos.com/kubernetes/docs/latest/openssl.html) to create the needed certificates and keys.
...
[Yes, ready to deploy the master node](https://coreos.com/kubernetes/docs/latest/deploy-master.html)
