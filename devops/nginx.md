...
[Original URL](http://www.aosabook.org/en/nginx.html)
...
A high-level overview of nginx architecture is presented in [Figure 14.1](http://www.aosabook.org/en/nginx.html#fig.nginx.arch).

![](http://www.aosabook.org/images/nginx/architecture.png) Figure 14.1: Diagram of nginx's architecture
