...
![Merge request with the branch name 15-require-a-password-to-change-it and assignee field shown](https://about.gitlab.com/images/git_flow/merge_request.png)
