# valerylisay/digitalocean-api

[Original URL](https://github.com/valerylisay/digitalocean-api)

> Simple and easy to use package that provides access to Digital Ocean API v2\. >>> from digitalocean import ClientV2 >>> client = ClientV2(token='your_token_here') >>>...
